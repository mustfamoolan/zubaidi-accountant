...
<div class="col-xl-5">
    <div class="card auth-card">
        <div class="card-body px-3 py-5">
            ...
            <h2 class="fw-bold text-uppercase text-center fs-18">Confirm Password</h2>
            <p class="text-muted text-center mt-1 mb-4">Please confirm your password before continuing.</p>
            ...
            <div class="px-4">
                <form action="{{ route('second', ['dashboards', 'analytics'])}}" class="authentication-form">
                    ...
                    <div class="mb-1 text-center d-grid">
                        <button class="btn btn-danger py-2 fw-medium" type="submit">Confirm Password</button>
                    </div>
                </form>
            </div> <!-- end col -->
        </div> <!-- end card-body -->
