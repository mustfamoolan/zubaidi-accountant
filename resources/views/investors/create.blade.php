@extends('layouts.vertical', ['title' => 'إضافة مستثمر جديد','subTitle' => 'إدارة المستثمرين'])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">إضافة مستثمر جديد</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('investors.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror"
                                      name="notes" rows="4" placeholder="أي ملاحظات إضافية...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="ri-save-line me-1"></i> حفظ المستثمر
                            </button>
...
<script src="{{ asset('js/investor-create.js') }}"></script>
